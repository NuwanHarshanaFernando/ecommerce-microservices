...
const ImagePlaceHolder = ({
  ...
  return (
    <div className={`relative ${
        ...
        } w-full cursor-pointer bg-[#1e1e1e] border border-gray-600
                ...
                imagePreview ? (
                    <>
                        <button type="button" onClick={() => onRemove?.(index!)}
                            className='absolute p-2 bg-red-600 rounded shadow-lg top-3 right-3'
                        >
                            <X size={16}/>
                        </button>
                    ...
                    <label 
                        ...
                        className='absolute p-2 rounded shadow-lg cursor-pointer top-3 right-3 bg-slate-700'>
                            <Pencil size={16}/>
